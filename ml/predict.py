...
# Verify torch is installed before proceeding
try:
    import torch
    import torch.nn as nn
    import torchvision.transforms as transforms
    import torchvision.models as models
    # Debug: Log PyTorch version and device info
    print(f'[PyTorch] Version: {torch.__version__}, Device: CPU', file=sys.stderr)
...
try:
    ...
    def append_log(msg): pass
    def ensure_log_file(): pass
